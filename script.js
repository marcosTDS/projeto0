...
function incrementBigHotSalmão() {
    var input = document.getElementById("BIG HOT SALMÃO-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementBigHotSalmão() {
    var input = document.getElementById("BIG HOT SALMÃO-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementBigHotSalmãoCamarão() {
    var input = document.getElementById("BIG HOT SALMÃO E CAMARÃO-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementBigHotSalmãoCamarão() {
    var input = document.getElementById("BIG HOT SALMÃO E CAMARÃO-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementBigHotCamarãoNatural() {
    var input = document.getElementById("BIG HOT CAMARÃO NATURAL-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementBigHotCamarãoNatural() {
    var input = document.getElementById("BIG HOT CAMARÃO NATURAL-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementBigHotKaneFiladélfia() {
    var input = document.getElementById("BIG HOT KANE FILADÉLFIA-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementBigHotKaneFiladélfia() {
    var input = document.getElementById("BIG HOT KANE FILADÉLFIA-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementNiguiriSalmão() {
    var input = document.getElementById("NIGUIRI SALMÃO 10 PEÇAS-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementNiguiriSalmão() {
    var input = document.getElementById("NIGUIRI SALMÃO 10 PEÇAS-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementSashimiSalmão() {
    var input = document.getElementById("SASHIMS SALMÃO 10 PEÇAS-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementSashimiSalmão() {
    var input = document.getElementById("SASHIMS SALMÃO 10 PEÇAS-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementEbyJow() {
    var input = document.getElementById("EBY JOW 3 PEÇAS-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementEbyJow() {
    var input = document.getElementById("EBY JOW 3 PEÇAS-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementEbyFlay() {
    var input = document.getElementById("EBY FLAY 3 PEÇAS-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementEbyFlay() {
    var input = document.getElementById("EBY FLAY 3 PEÇAS-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementLogiaBollSimples() {
    var input = document.getElementById("LOGIA BOLL SIMPLES 6 PEÇAS-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementLogiaBollSimples() {
    var input = document.getElementById("LOGIA BOLL SIMPLES 6 PEÇAS-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementLogiaBollTurbinado() {
    var input = document.getElementById("LOGIA BOLL TURBINADO 8 PEÇAS-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementLogiaBollTurbinado() {
    var input = document.getElementById("LOGIA BOLL TURBINADO 8 PEÇAS-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementSushiBurguer() {
    var input = document.getElementById("SUSHI BURGUER-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementSushiBurguer() {
    var input = document.getElementById("SUSHI BURGUER-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementSalmãoSimples() {
    var input = document.getElementById("SALMÃO SIMPLES-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementSalmãoSimples() {
    var input = document.getElementById("SALMÃO SIMPLES-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementSalmãoFiladélfia() {
    var input = document.getElementById("SALMÃO FILADÉLFIA-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementSalmãoFiladélfia() {
    var input = document.getElementById("SALMÃO FILADÉLFIA-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementCamarãoCrocante() {
    var input = document.getElementById("CAMARÃO CROCANTE-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementCamarãoCrocante() {
    var input = document.getElementById("CAMARÃO CROCANTE-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementKaniFiladélfia() {
    var input = document.getElementById("KANI FILADÉLFIA-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementKaniFiladélfia() {
    var input = document.getElementById("KANI FILADÉLFIA-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementCamarãoNatural() {
    var input = document.getElementById("CAMARÃO NATURAL-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementCamarãoNatural() {
    var input = document.getElementById("CAMARÃO NATURAL-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementKaniCrocante() {
    var input = document.getElementById("KANI CROCANTE-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementKaniCrocante() {
    var input = document.getElementById("KANI CROCANTE-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementSalmãoSupremo() {
    var input = document.getElementById("SALMÃO SUPREMO-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementSalmãoSupremo() {
    var input = document.getElementById("SALMÃO SUPREMO-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementRefrigerante() {
    var input = document.getElementById("REFRIGERANTE-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementRefrigerante() {
    var input = document.getElementById("REFRIGERANTE-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementH2o() {
    var input = document.getElementById("H2O-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementH2o() {
    var input = document.getElementById("H2O-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementShueps() {
    var input = document.getElementById("SHUEPS-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementShueps() {
    var input = document.getElementById("SHUEPS-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementTonica() {
    var input = document.getElementById("TONICA-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementTonica() {
    var input = document.getElementById("TONICA-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}

function incrementRefrigeranteLitro() {
    var input = document.getElementById("REFRIGERANTE 1LT-quantidade");
    input.value = parseInt(input.value) + 1;
}

function decrementRefrigeranteLitro() {
    var input = document.getElementById("REFRIGERANTE 1LT-quantidade");
    input.value = Math.max(0, parseInt(input.value) - 1); 
}
